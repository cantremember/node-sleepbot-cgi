...
/*
    sticky dependencies
        underscore@1.6.x, because https://gist.github.com/jashkenas/cbd2b088e20279ae2c8e
*/
    ...
    wwwRoot: {
        ...
        willLoadTSV: function willLoadTSV(relativePath, options) {
            return new Promise(function(resolve, reject) {
                try {
                    var filepath = path.join(theLib.config.wwwRoot, relativePath);
        ...
        willDetectFile: function willDetectFile(relativePath) {
            return willStat(path.join(theLib.config.wwwRoot, relativePath))
            .then(function(stat) {
                return stat.isFile();
            })
            .catch(function(err) {

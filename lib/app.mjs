...
import redirectToRandomFile from '../app/redirectToRandomFile.mjs';
import redirectTo from '../app/redirectTo.mjs';

import routeStatus from '../app/status.mjs';
import routeHttp404 from '../app/http404.mjs';
import routeSebPlaylistASX from '../app/sebPlaylist.ASX.mjs';
import routeSebPlaylistM3U from '../app/sebPlaylist.M3U.mjs';
import routeSebPlaylistPLS from '../app/sebPlaylist.PLS.mjs';
import routeSebPlaylistRM from '../app/sebPlaylist.RM.mjs';
import routeSebStatusHTML from '../app/sebStatusHTML.mjs';
import routeSebStatusXML from '../app/sebStatusXML.mjs';
import routeAmbienceAnySample from '../app/ambienceAnySample.mjs';
import routeFuccSchedule from '../app/fuccSchedule.mjs';
import routeLookitAnyStory from '../app/lookitAnyStory.mjs';
import routeLookitImgFoley from '../app/lookitImgFoley.mjs';
import routeMorganLayout from '../app/morganLayout.mjs';
import routeMorganIndex from '../app/morganIndex.mjs';
import routeWRLDtimeUTC from '../app/WRLDtimeUTC.mjs';
...
//   /ambience
//   /ambience/cgi/listen.cgi/listen.*
//     CGI file interrupts path resolution
//     URI resolves as its filename past the final '/'
//     implemented it as such in nginx.conf
app.route('/ambience/cgi/listen.cgi').all(routeSebPlaylistM3U); // default = M3U
app.route('/ambience/cgi/listen.cgi*').all(routeSebPlaylistPLS); // legacy = 'listen.cgi/listen.pls'
app.route('/ambience/cgi/listen.asx').all(routeSebPlaylistASX);
app.route('/ambience/cgi/listen.m3u').all(routeSebPlaylistM3U);
app.route('/ambience/cgi/listen.pls').all(routeSebPlaylistPLS);
app.route('/ambience/cgi/listen.rm').all(routeSebPlaylistRM);
...
export function logError(err, req, res, next) {
  ...
  const json = pick(err, 'name', 'message');

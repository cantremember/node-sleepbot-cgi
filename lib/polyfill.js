...
if (typeof Symbol === 'undefined') {
    global.Symbol = require('es6-symbol'); // eslint-disable-line global-require
}
 ...
 */
export function Array_includes(...args) { // eslint-disable-line camelcase
...
((prototype) => {
    ...
    prototype.includes = Array_includes; // eslint-disable-line camelcase
})(Array.prototype);
 ...
 * @returns true or false as appropriate
 */
export function String_includes(...args) { // eslint-disable-line camelcase
    return (this.indexOf(...args) !== -1);
}
...
((prototype) => {
    ...
    prototype.includes = String_includes; // eslint-disable-line camelcase
})(String.prototype);
 ...
 * @returns true or false as appropriate
 */
export function Object_assign(...args) { // eslint-disable-line camelcase
...
((klass) => {
    ...
    klass.assign = Object_assign; // eslint-disable-line camelcase
})(Object);
